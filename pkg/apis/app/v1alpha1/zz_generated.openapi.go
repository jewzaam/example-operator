...
func schema_pkg_apis_app_v1alpha1_AppService(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/jewzaam/example-operator/pkg/apis/app/v1alpha1.AppServiceSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/jewzaam/example-operator/pkg/apis/app/v1alpha1.AppServiceStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/jewzaam/example-operator/pkg/apis/app/v1alpha1.AppServiceSpec", "github.com/jewzaam/example-operator/pkg/apis/app/v1alpha1.AppServiceStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
